          ...
          >
            ...
            <div className="p-6">
              <p className="text-sm font-serif text-text-taupe mb-4 leading-relaxed">
                Everything you need to know about virtual machines, operating
                systems, Linux, servers, kernels, SSH, and essential terminal
                commands — explained with real-world analogies.
              </p>
              <div className="flex flex-wrap gap-2">
                {["VMs", "Linux", "OS", "Kernel", "Servers", "SSH", "Ubuntu", "Terminal"].map((tag) => (
                  <span
                    key={tag}
